...
def api_importFile(simulation_type=None):
    ...
    try:
        ...
        #TODO(pjm): need a separate URI interface to importer, added exception for robot for now
        # (dicom input is normally a zip file)
        elif pkio.has_file_extension(f.filename, 'zip') and template.SIM_TYPE != 'robot':
